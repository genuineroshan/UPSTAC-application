...
public class ConsultationController {
    ...
    public List<TestRequest> getForDoctor() {
        // Load the current logged in user to validate against the role
        User loggedInUser = userLoggedInService.getLoggedInUser();

        // load the tests consultation assigned to respective doctor.
    ...
    public TestRequest assignForConsultation(@PathVariable Long id) {
        try {
            ...
            // Update test request for consultation to current logged in user.
